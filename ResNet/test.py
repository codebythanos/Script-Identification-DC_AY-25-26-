...
NUM_CLASSES = 12
SEED        = 42
WEIGHTS_PATH = 'p1_50k_best.keras'
...
plt.title(f'Confusion Matrix — ViT 50K Aug | Acc: {test_acc:.4f}', fontsize=14)
plt.xlabel('Predicted'); plt.ylabel('True')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('confusion_matrix_50k.png', dpi=150, bbox_inches='tight')
plt.show()
print("Saved: confusion_matrix_50k.png")
